...
export default function EnrolledStudentsView({ readOnly = false }: EnrolledStudentsViewProps) {
  ...
  return (
    <Container maxWidth="xl" sx={{ mt: 8 }}>
      <Typography variant="h4" component="h1" sx={{ fontWeight: 700, mb: 4 }}>
        {readOnly ? "Buscar Lista de Alumnas por Categorías" : "Lista de Alumnas Inscritas"}
      </Typography>
      ...
      {/* Update Level Dialog - Solo mostrar si no es readOnly */}
      {!readOnly && (
